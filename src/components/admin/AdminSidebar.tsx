...
const nav = [
  ...
  { href: "/admin/billing/plans", label: "Plans", icon: "£" },
  { href: "/admin/billing/products", label: "Products", icon: "◆" },
  { href: "/admin/billing/purchases", label: "Purchases", icon: "↗" },
  { href: "/admin/billing/subscriptions", label: "Subscriptions", icon: "⟳" },
